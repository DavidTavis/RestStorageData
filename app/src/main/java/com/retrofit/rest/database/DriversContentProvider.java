...
public class DriversContentProvider extends ContentProvider {

    private static final int DRIVERS_TABLE = 1;

    private static final UriMatcher URI_MATCHER;

    static {
        URI_MATCHER = new UriMatcher(UriMatcher.NO_MATCH);
        URI_MATCHER.addURI(SQLiteHelper.CONTENT_AUTHORITY, DriversTable.Requests.TABLE_NAME, DRIVERS_TABLE);
    }
    ...
    public String getType(@NonNull Uri uri) {
        switch (URI_MATCHER.match(uri)) {
            case DRIVERS_TABLE:
                return DriversTable.Requests.TABLE_NAME;
            default:
                return "";
        }
    }
